...
export const Footer: React.FC = () => {
  return (
    <footer className="py-12 px-4 sm:px-6 bg-[#0A0B10] border-t border-white/10 text-sm font-mono text-[#D1D5DB]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <span className="font-serifTitle text-xl font-bold text-white tracking-wide">
            LUKAJÚ
          </span>
        </div>
        ...
        <div className="flex items-center gap-8 text-[#E5E7EB]">
          ...
          >
            <Heart className="w-4 h-4 text-[#F43F5E]" /> Patreon
          </a>
          ...
          <a
            ...
            className="hover:text-white transition-colors flex items-center gap-2 font-medium"
          >
            <ExternalLink className="w-4 h-4 text-[#D1D5DB]" /> Itch.io
          </a>
        </div>
